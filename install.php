<?php
// File: install.php - Installer Kinet-Bill lengkap dengan konfigurasi MikroTik
...
<head>
    ...
    <title>Instalasi Kinet-Bill Internet Billing and Management System</title>
...
<body>
    <div class="navbar">
        <div class="container">
            <h1><i class="fas fa-network-wired"></i>Kinet-Bill Installer</h1>
        </div>
    </div>
...
switch ($current_step) {
    case 'check_requirements':
        ...
        echo '<p>Memverifikasi bahwa server memenuhi persyaratan minimum untuk menjalankan sistem Kinet-Bill...</p>';
    ...
    case 'create_tables':
        ...
        echo '</div>';
        echo '<div class="card-body">';
        echo '<p>Membangun struktur tabel yang diperlukan untuk system Kinet-Bill...</p>';
    ...
    case 'finish':
        ...
        echo '</div>';
        echo '<div class="card-body">';
        echo '<div class="alert alert-success"><i class="fas fa-check-circle"></i>Sistem Kinet-Bill berhasil diinstal!</div>';
